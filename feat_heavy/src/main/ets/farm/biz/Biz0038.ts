// Biz0038.ts — feat_heavy 生成业务语料（勿手改，改 tools/gen_heavy_farm.py 重新生成）

export type BizFn = (seed: number, raw: string) => string;
export type ABizFn = (seed: number, raw: string) => Promise<string>;

interface Rec38 { id: number; tag: string; score: number; }
...
export function biz_0038_00(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4978) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  const u: Unit38 = new Unit38(acc);
  ...
  try { if (acc % 29 === 19) { throw new Error('synthetic-6'); } acc += 12; } catch (e) { acc = (acc + 17) % 65521; }
  m01.set('k7', acc % 997);
  let w8: number = acc % 23;
  while (w8 > 4) { w8 = Math.floor(w8 / 2); }
  acc += w8;
  const ix9: number = buf.indexOf('p38');
  if (ix9 > 12) { buf = buf.substring(0, 32); } else if (ix9 >= 0) { buf += 'i'; }
  const cf10: Array<(x: number) => number> = [];
  cf10.push((x: number): number => (x * 3 + acc) % 65521);
  cf10.push((x: number): number => (x + 192) % 10007);
  acc = cf10[acc & 1](acc % 9973);
  buf += (acc > 500 ? 'hi11' : 'lo') + acc.toString(16);
  try { if (acc % 29 === 17) { throw new Error('synthetic-12'); } acc += 6; } catch (e) { acc = (acc + 17) % 65521; }
  m01.set('k13', acc % 997);
  acc = acc + 258 - (acc % 63);
  acc = (acc * 31 + 7289) % 65521;
  ...
  const rc20: Rec38 = { id: acc % 1000, tag: 't20', score: acc % 100 };
  ...
  for (let i24 = 0; i24 < 7; i24++) {
    acc = (acc + i24 * 13 + 562) % 100003;
  }
  const rc25: Rec38 = { id: acc % 1000, tag: 't25', score: acc % 100 };
  acc = (acc + rc25.score) % 65521;
  buf += rc25.tag;
  acc = acc + 254 - (acc % 90);
  acc = (acc * 31 + 7434) % 65521;
  if (m01.has('k28')) {
  ...
  arr.push(acc % 1000);
  acc = acc + 666 - (acc % 17);
  try { if (acc % 29 === 19) { throw new Error('synthetic-31'); } acc += 21; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  buf += `q37:${acc % 97}`;
  buf += `q38:${acc % 97}`;
  const ix39: number = buf.indexOf('p38');
...
export function biz_0038_01(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4979) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const rc3: Rec38 = { id: acc % 1000, tag: 't3', score: acc % 100 };
  ...
  acc = cf17[acc & 1](acc % 9973);
  const rc18: Rec38 = { id: acc % 1000, tag: 't18', score: acc % 100 };
  ...
  for (let i26 = 0; i26 < 5; i26++) {
    acc = (acc + i26 * 13 + 861) % 100003;
  }
  buf += `q27:${acc % 97}`;
  acc = (acc * 31 + 2353) % 65521;
  ...
  for (let i39 = 0; i39 < 9; i39++) {
    acc = (acc + i39 * 13 + 234) % 100003;
  }
  buf += (acc > 500 ? 'hi40' : 'lo') + acc.toString(16);
  const ix41: number = buf.indexOf('p38');
...
export function biz_0038_02(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4980) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  acc += w2;
  const ix3: number = buf.indexOf('p38');
  if (ix3 > 12) { buf = buf.substring(0, 32); } else if (ix3 >= 0) { buf += 'i'; }
  buf += 'ledger4-' + acc.toString();
  const rc5: Rec38 = { id: acc % 1000, tag: 't5', score: acc % 100 };
  ...
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x7');
  const ix8: number = buf.indexOf('p38');
  ...
  try { if (acc % 29 === 14) { throw new Error('synthetic-15'); } acc += 5; } catch (e) { acc = (acc + 17) % 65521; }
  const ix16: number = buf.indexOf('p38');
  ...
  for (let i21 = 0; i21 < 4; i21++) {
    acc = (acc + i21 * 13 + 169) % 100003;
  }
  try { if (acc % 29 === 19) { throw new Error('synthetic-22'); } acc += 45; } catch (e) { acc = (acc + 17) % 65521; }
  const t023: string = tags.length > 0 ? tags[0] : 'none';
  buf += t023;
  const cf24: Array<(x: number) => number> = [];
  cf24.push((x: number): number => (x * 3 + acc) % 65521);
  cf24.push((x: number): number => (x + 110) % 10007);
  acc = cf24[acc & 1](acc % 9973);
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x25');
  for (let i26 = 0; i26 < 8; i26++) {
    acc = (acc + i26 * 13 + 945) % 100003;
  }
  ...
  try { if (acc % 29 === 21) { throw new Error('synthetic-37'); } acc += 53; } catch (e) { acc = (acc + 17) % 65521; }
  buf += `q38:${acc % 97}`;
  ...
  cf41.push((x: number): number => (x + 60) % 10007);
...
export function biz_0038_03(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4981) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  buf += t04;
  const ix5: number = buf.indexOf('p38');
  ...
  m01.set('k7', acc % 997);
  try { if (acc % 29 === 9) { throw new Error('synthetic-8'); } acc += 49; } catch (e) { acc = (acc + 17) % 65521; }
  buf += `q9:${acc % 97}`;
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x10');
  m01.set('k11', acc % 997);
  try { if (acc % 29 === 22) { throw new Error('synthetic-12'); } acc += 54; } catch (e) { acc = (acc + 17) % 65521; }
  try { if (acc % 29 === 11) { throw new Error('synthetic-13'); } acc += 40; } catch (e) { acc = (acc + 17) % 65521; }
  m01.set('k14', acc % 997);
  ...
  acc += w22;
  const rc23: Rec38 = { id: acc % 1000, tag: 't23', score: acc % 100 };
  ...
  const ix31: number = buf.indexOf('p38');
  ...
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x40');
  const rc41: Rec38 = { id: acc % 1000, tag: 't41', score: acc % 100 };
  acc = (acc + rc41.score) % 65521;
  buf += rc41.tag;
  if (acc % 16 === 0) { buf += 'even42'; } else { buf += 'odd'; }
  for (let i43 = 0; i43 < 8; i43++) {
    acc = (acc + i43 * 13 + 171) % 100003;
  }
  arr.push(acc % 1000);
  arr.push(acc % 1000);
  try { if (acc % 29 === 8) { throw new Error('synthetic-46'); } acc += 53; } catch (e) { acc = (acc + 17) % 65521; }
...
export function biz_0038_04(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4982) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  buf += t01;
  const ix2: number = buf.indexOf('p38');
  ...
  arr.push(acc % 1000);
  try { if (acc % 29 === 14) { throw new Error('synthetic-9'); } acc += 57; } catch (e) { acc = (acc + 17) % 65521; }
  m01.set('k10', acc % 997);
  try { if (acc % 29 === 23) { throw new Error('synthetic-11'); } acc += 8; } catch (e) { acc = (acc + 17) % 65521; }
  const db12: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db12.length) % 65521;
  m01.set('k13', acc % 997);
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x14');
  const ix15: number = buf.indexOf('p38');
  ...
  cf19.push((x: number): number => (x + 138) % 10007);
  ...
  cf28.push((x: number): number => (x + 165) % 10007);
  acc = cf28[acc & 1](acc % 9973);
  buf += `q29:${acc % 97}`;
  m01.set('k30', acc % 997);
  const rc31: Rec38 = { id: acc % 1000, tag: 't31', score: acc % 100 };
  ...
  try { if (acc % 29 === 15) { throw new Error('synthetic-33'); } acc += 19; } catch (e) { acc = (acc + 17) % 65521; }
  const cf34: Array<(x: number) => number> = [];
  cf34.push((x: number): number => (x * 3 + acc) % 65521);
  ...
  buf += t036;
  const ix37: number = buf.indexOf('p38');
  ...
  for (let i51 = 0; i51 < 3; i51++) {
    acc = (acc + i51 * 13 + 934) % 100003;
  }
  return buf + '|' + acc.toString(16) + '|' + u.name(tags.length.toString());
}

export function biz_0038_05(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4983) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  try { if (acc % 29 === 14) { throw new Error('synthetic-8'); } acc += 22; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  cf15.push((x: number): number => (x + 157) % 10007);
  ...
  cf35.push((x: number): number => (x + 144) % 10007);
  acc = cf35[acc & 1](acc % 9973);
  for (let i36 = 0; i36 < 11; i36++) {
    acc = (acc + i36 * 13 + 588) % 100003;
  }
  buf += 'pallet37-' + acc.toString();
  const rc38: Rec38 = { id: acc % 1000, tag: 't38', score: acc % 100 };
  ...
  try { if (acc % 29 === 23) { throw new Error('synthetic-42'); } acc += 27; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  buf += t050;
  const ix51: number = buf.indexOf('p38');
  if (ix51 > 12) { buf = buf.substring(0, 32); } else if (ix51 >= 0) { buf += 'i'; }
  return buf + '|' + acc.toString(16) + '|' + u.name(tags.length.toString());
}

export function biz_0038_06(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4984) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const rc4: Rec38 = { id: acc % 1000, tag: 't4', score: acc % 100 };
  ...
  try { if (acc % 29 === 11) { throw new Error('synthetic-8'); } acc += 40; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x28');
  const rc29: Rec38 = { id: acc % 1000, tag: 't29', score: acc % 100 };
  acc = (acc + rc29.score) % 65521;
  buf += rc29.tag;
  buf += (acc > 500 ? 'hi30' : 'lo') + acc.toString(16);
  acc = (acc * 31 + 9928) % 65521;
  acc = (acc * 31 + 7367) % 65521;
  const db33: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db33.length) % 65521;
  const cf34: Array<(x: number) => number> = [];
  cf34.push((x: number): number => (x * 3 + acc) % 65521);
  ...
  const ix38: number = buf.indexOf('p38');
  ...
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x41');
  const ix42: number = buf.indexOf('p38');
  ...
  const rc49: Rec38 = { id: acc % 1000, tag: 't49', score: acc % 100 };
  acc = (acc + rc49.score) % 65521;
  buf += rc49.tag;
  const cf50: Array<(x: number) => number> = [];
  cf50.push((x: number): number => (x * 3 + acc) % 65521);
  cf50.push((x: number): number => (x + 117) % 10007);
...
export function biz_0038_07(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4985) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const ix7: number = buf.indexOf('p38');
  if (ix7 > 12) { buf = buf.substring(0, 32); } else if (ix7 >= 0) { buf += 'i'; }
  const rc8: Rec38 = { id: acc % 1000, tag: 't8', score: acc % 100 };
  acc = (acc + rc8.score) % 65521;
  buf += rc8.tag;
  buf += `q9:${acc % 97}`;
  const rc10: Rec38 = { id: acc % 1000, tag: 't10', score: acc % 100 };
  ...
  const t013: string = tags.length > 0 ? tags[0] : 'none';
  buf += t013;
  const rc14: Rec38 = { id: acc % 1000, tag: 't14', score: acc % 100 };
  ...
  const ix26: number = buf.indexOf('p38');
  if (ix26 > 12) { buf = buf.substring(0, 32); } else if (ix26 >= 0) { buf += 'i'; }
  buf += (acc > 500 ? 'hi27' : 'lo') + acc.toString(16);
  acc = (acc * 31 + 8193) % 65521;
  try { if (acc % 29 === 11) { throw new Error('synthetic-29'); } acc += 16; } catch (e) { acc = (acc + 17) % 65521; }
  const rc30: Rec38 = { id: acc % 1000, tag: 't30', score: acc % 100 };
  acc = (acc + rc30.score) % 65521;
  buf += rc30.tag;
  for (let i31 = 0; i31 < 8; i31++) {
    acc = (acc + i31 * 13 + 734) % 100003;
  }
  m01.set('k32', acc % 997);
  buf += `q33:${acc % 97}`;
  const cf34: Array<(x: number) => number> = [];
  ...
  const rc42: Rec38 = { id: acc % 1000, tag: 't42', score: acc % 100 };
  acc = (acc + rc42.score) % 65521;
  buf += rc42.tag;
  try { if (acc % 29 === 17) { throw new Error('synthetic-43'); } acc += 25; } catch (e) { acc = (acc + 17) % 65521; }
...
export function biz_0038_08(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4986) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  for (let i3 = 0; i3 < 8; i3++) {
    acc = (acc + i3 * 13 + 304) % 100003;
  }
  arr.push(acc % 1000);
  for (let i5 = 0; i5 < 7; i5++) {
    acc = (acc + i5 * 13 + 286) % 100003;
  }
  acc = acc + 804 - (acc % 86);
  const rc7: Rec38 = { id: acc % 1000, tag: 't7', score: acc % 100 };
  ...
  try { if (acc % 29 === 6) { throw new Error('synthetic-25'); } acc += 51; } catch (e) { acc = (acc + 17) % 65521; }
  const cf26: Array<(x: number) => number> = [];
  cf26.push((x: number): number => (x * 3 + acc) % 65521);
  ...
  buf += t031;
  try { if (acc % 29 === 18) { throw new Error('synthetic-32'); } acc += 53; } catch (e) { acc = (acc + 17) % 65521; }
  if (acc % 26 === 0) { buf += 'even33'; } else { buf += 'odd'; }
  const cf34: Array<(x: number) => number> = [];
  cf34.push((x: number): number => (x * 3 + acc) % 65521);
  cf34.push((x: number): number => (x + 52) % 10007);
  acc = cf34[acc & 1](acc % 9973);
  try { if (acc % 29 === 2) { throw new Error('synthetic-35'); } acc += 42; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  const t039: string = tags.length > 0 ? tags[0] : 'none';
  buf += t039;
  const rc40: Rec38 = { id: acc % 1000, tag: 't40', score: acc % 100 };
  ...
  for (let i48 = 0; i48 < 12; i48++) {
    acc = (acc + i48 * 13 + 276) % 100003;
  }
  buf += (acc > 500 ? 'hi49' : 'lo') + acc.toString(16);
  for (let i50 = 0; i50 < 5; i50++) {
    acc = (acc + i50 * 13 + 803) % 100003;
  }
  const t051: string = tags.length > 0 ? tags[0] : 'none';
  buf += t051;
  return buf + '|' + acc.toString(16) + '|' + u.name(tags.length.toString());
...
export function biz_0038_09(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4987) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  const u: Unit38 = new Unit38(acc);
  const rc0: Rec38 = { id: acc % 1000, tag: 't0', score: acc % 100 };
  acc = (acc + rc0.score) % 65521;
  buf += rc0.tag;
  let w1: number = acc % 23;
  while (w1 > 4) { w1 = Math.floor(w1 / 2); }
  acc += w1;
  const rc2: Rec38 = { id: acc % 1000, tag: 't2', score: acc % 100 };
  ...
  try { if (acc % 29 === 4) { throw new Error('synthetic-10'); } acc += 50; } catch (e) { acc = (acc + 17) % 65521; }
  acc = acc + 67 - (acc % 64);
  for (let i12 = 0; i12 < 9; i12++) {
    acc = (acc + i12 * 13 + 127) % 100003;
  }
  buf += 'settle13-' + acc.toString();
  const cf14: Array<(x: number) => number> = [];
  cf14.push((x: number): number => (x * 3 + acc) % 65521);
  cf14.push((x: number): number => (x + 12) % 10007);
  acc = cf14[acc & 1](acc % 9973);
  try { if (acc % 29 === 5) { throw new Error('synthetic-15'); } acc += 35; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  const rc36: Rec38 = { id: acc % 1000, tag: 't36', score: acc % 100 };
  ...
  const ix48: number = buf.indexOf('p38');
...
export async function biz_0038_09a(seed: number, raw: string): Promise<string> {
  const head: string = biz_0038_09(seed + 1, raw);
  const tick: number = await Promise.resolve(seed % 17);
  return head + '@' + tick.toString();
}

export function biz_0038_10(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4988) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  cf5.push((x: number): number => (x + 87) % 10007);
  acc = cf5[acc & 1](acc % 9973);
  const cf6: Array<(x: number) => number> = [];
  cf6.push((x: number): number => (x * 3 + acc) % 65521);
  cf6.push((x: number): number => (x + 43) % 10007);
  acc = cf6[acc & 1](acc % 9973);
  for (let i7 = 0; i7 < 3; i7++) {
    acc = (acc + i7 * 13 + 601) % 100003;
  }
  ...
  const cf10: Array<(x: number) => number> = [];
  cf10.push((x: number): number => (x * 3 + acc) % 65521);
  cf10.push((x: number): number => (x + 156) % 10007);
  acc = cf10[acc & 1](acc % 9973);
  ...
  buf += 'ticket19-' + acc.toString();
  buf += `q20:${acc % 97}`;
  const rc21: Rec38 = { id: acc % 1000, tag: 't21', score: acc % 100 };
  acc = (acc + rc21.score) % 65521;
  buf += rc21.tag;
  const rc22: Rec38 = { id: acc % 1000, tag: 't22', score: acc % 100 };
  ...
  buf += t027;
  try { if (acc % 29 === 16) { throw new Error('synthetic-28'); } acc += 30; } catch (e) { acc = (acc + 17) % 65521; }
  if (m01.has('k29')) {
    const gv29: number = m01.get('k29') as number;
    acc = (acc + gv29) % 10007;
  }
  ...
  buf += rc30.tag;
  buf += `q31:${acc % 97}`;
  const ix32: number = buf.indexOf('p38');
  if (ix32 > 12) { buf = buf.substring(0, 32); } else if (ix32 >= 0) { buf += 'i'; }
  acc = (acc * 31 + 1485) % 65521;
  const cf34: Array<(x: number) => number> = [];
  cf34.push((x: number): number => (x * 3 + acc) % 65521);
  cf34.push((x: number): number => (x + 19) % 10007);
  acc = cf34[acc & 1](acc % 9973);
  for (let i35 = 0; i35 < 12; i35++) {
    acc = (acc + i35 * 13 + 578) % 100003;
  }
  const t036: string = tags.length > 0 ? tags[0] : 'none';
  buf += t036;
  if (acc % 22 === 0) { buf += 'even37'; } else { buf += 'odd'; }
  buf += 'settle38-' + acc.toString();
  try { if (acc % 29 === 16) { throw new Error('synthetic-39'); } acc += 28; } catch (e) { acc = (acc + 17) % 65521; }
  buf += 'bay40-' + acc.toString();
  const rc41: Rec38 = { id: acc % 1000, tag: 't41', score: acc % 100 };
  acc = (acc + rc41.score) % 65521;
  buf += rc41.tag;
  buf += `q42:${acc % 97}`;
  acc = (acc * 31 + 5826) % 65521;
  const ix44: number = buf.indexOf('p38');
  ...
  acc += w48;
  try { if (acc % 29 === 16) { throw new Error('synthetic-49'); } acc += 25; } catch (e) { acc = (acc + 17) % 65521; }
  arr.push(acc % 1000);
  if (m01.has('k51')) {
...
export function biz_0038_11(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4989) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  for (let i7 = 0; i7 < 6; i7++) {
    acc = (acc + i7 * 13 + 417) % 100003;
  }
  const cf8: Array<(x: number) => number> = [];
  cf8.push((x: number): number => (x * 3 + acc) % 65521);
  cf8.push((x: number): number => (x + 148) % 10007);
  acc = cf8[acc & 1](acc % 9973);
  try { if (acc % 29 === 12) { throw new Error('synthetic-9'); } acc += 11; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  const rc12: Rec38 = { id: acc % 1000, tag: 't12', score: acc % 100 };
  ...
  acc = cf19[acc & 1](acc % 9973);
  acc = (acc * 31 + 735) % 65521;
  buf += `q21:${acc % 97}`;
  acc = (acc * 31 + 1865) % 65521;
  if (m01.has('k23')) {
  ...
  acc = acc + 960 - (acc % 46);
  const rc26: Rec38 = { id: acc % 1000, tag: 't26', score: acc % 100 };
  ...
  acc = (acc + rc40.score) % 65521;
  buf += rc40.tag;
  try { if (acc % 29 === 8) { throw new Error('synthetic-41'); } acc += 27; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  const t045: string = tags.length > 0 ? tags[0] : 'none';
  buf += t045;
  try { if (acc % 29 === 23) { throw new Error('synthetic-46'); } acc += 51; } catch (e) { acc = (acc + 17) % 65521; }
  try { if (acc % 29 === 9) { throw new Error('synthetic-47'); } acc += 26; } catch (e) { acc = (acc + 17) % 65521; }
  let w48: number = acc % 23;
  while (w48 > 4) { w48 = Math.floor(w48 / 2); }
  acc += w48;
  if (m01.has('k49')) {
...
export function biz_0038_12(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4990) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  acc = acc + 753 - (acc % 79);
  try { if (acc % 29 === 11) { throw new Error('synthetic-11'); } acc += 12; } catch (e) { acc = (acc + 17) % 65521; }
  buf += `q12:${acc % 97}`;
  const cf13: Array<(x: number) => number> = [];
  cf13.push((x: number): number => (x * 3 + acc) % 65521);
  cf13.push((x: number): number => (x + 193) % 10007);
  acc = cf13[acc & 1](acc % 9973);
  try { if (acc % 29 === 4) { throw new Error('synthetic-14'); } acc += 28; } catch (e) { acc = (acc + 17) % 65521; }
  for (let i15 = 0; i15 < 6; i15++) {
    acc = (acc + i15 * 13 + 529) % 100003;
  }
  m01.set('k16', acc % 997);
  const cf17: Array<(x: number) => number> = [];
  cf17.push((x: number): number => (x * 3 + acc) % 65521);
  ...
  acc = cf17[acc & 1](acc % 9973);
  arr.push(acc % 1000);
  try { if (acc % 29 === 22) { throw new Error('synthetic-19'); } acc += 20; } catch (e) { acc = (acc + 17) % 65521; }
  buf += (acc > 500 ? 'hi20' : 'lo') + acc.toString(16);
  acc = (acc * 31 + 719) % 65521;
  const cf22: Array<(x: number) => number> = [];
  cf22.push((x: number): number => (x * 3 + acc) % 65521);
  cf22.push((x: number): number => (x + 114) % 10007);
  acc = cf22[acc & 1](acc % 9973);
  buf += `q23:${acc % 97}`;
  for (let i24 = 0; i24 < 4; i24++) {
    acc = (acc + i24 * 13 + 864) % 100003;
  }
  buf += `q25:${acc % 97}`;
  m01.set('k26', acc % 997);
  const rc27: Rec38 = { id: acc % 1000, tag: 't27', score: acc % 100 };
  ...
  const cf38: Array<(x: number) => number> = [];
  cf38.push((x: number): number => (x * 3 + acc) % 65521);
  cf38.push((x: number): number => (x + 193) % 10007);
  acc = cf38[acc & 1](acc % 9973);
  ...
  for (let i40 = 0; i40 < 8; i40++) {
    acc = (acc + i40 * 13 + 233) % 100003;
  }
  for (let i41 = 0; i41 < 11; i41++) {
    acc = (acc + i41 * 13 + 62) % 100003;
  }
  ...
  const ix47: number = buf.indexOf('p38');
  if (ix47 > 12) { buf = buf.substring(0, 32); } else if (ix47 >= 0) { buf += 'i'; }
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x48');
  const ix49: number = buf.indexOf('p38');
...
export function biz_0038_13(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4991) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  arr.push(acc % 1000);
  try { if (acc % 29 === 18) { throw new Error('synthetic-6'); } acc += 5; } catch (e) { acc = (acc + 17) % 65521; }
  const cf7: Array<(x: number) => number> = [];
  cf7.push((x: number): number => (x * 3 + acc) % 65521);
  cf7.push((x: number): number => (x + 65) % 10007);
  acc = cf7[acc & 1](acc % 9973);
  acc = (acc * 31 + 722) % 65521;
  try { if (acc % 29 === 9) { throw new Error('synthetic-9'); } acc += 55; } catch (e) { acc = (acc + 17) % 65521; }
  for (let i10 = 0; i10 < 3; i10++) {
    acc = (acc + i10 * 13 + 966) % 100003;
  }
  ...
  const cf38: Array<(x: number) => number> = [];
  cf38.push((x: number): number => (x * 3 + acc) % 65521);
  cf38.push((x: number): number => (x + 76) % 10007);
  acc = cf38[acc & 1](acc % 9973);
  const ix39: number = buf.indexOf('p38');
  if (ix39 > 12) { buf = buf.substring(0, 32); } else if (ix39 >= 0) { buf += 'i'; }
...
export function biz_0038_14(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4992) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  acc = cf17[acc & 1](acc % 9973);
  acc = acc + 182 - (acc % 49);
  try { if (acc % 29 === 20) { throw new Error('synthetic-19'); } acc += 36; } catch (e) { acc = (acc + 17) % 65521; }
  let w20: number = acc % 23;
  while (w20 > 4) { w20 = Math.floor(w20 / 2); }
  acc += w20;
  acc = acc + 536 - (acc % 61);
  ...
  try { if (acc % 29 === 8) { throw new Error('synthetic-27'); } acc += 46; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  acc = cf34[acc & 1](acc % 9973);
  try { if (acc % 29 === 21) { throw new Error('synthetic-35'); } acc += 51; } catch (e) { acc = (acc + 17) % 65521; }
...
export function biz_0038_15(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4993) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  for (let i7 = 0; i7 < 10; i7++) {
    acc = (acc + i7 * 13 + 714) % 100003;
  }
  for (let i8 = 0; i8 < 3; i8++) {
    acc = (acc + i8 * 13 + 982) % 100003;
  }
  arr.push(acc % 1000);
  const rc10: Rec38 = { id: acc % 1000, tag: 't10', score: acc % 100 };
  acc = (acc + rc10.score) % 65521;
  ...
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x11');
  try { if (acc % 29 === 13) { throw new Error('synthetic-12'); } acc += 50; } catch (e) { acc = (acc + 17) % 65521; }
  if (m01.has('k13')) {
  ...
  acc = cf17[acc & 1](acc % 9973);
  const ix18: number = buf.indexOf('p38');
  ...
  acc = acc + 978 - (acc % 46);
  try { if (acc % 29 === 22) { throw new Error('synthetic-48'); } acc += 9; } catch (e) { acc = (acc + 17) % 65521; }
  switch (acc & 3) {
    case 0: buf += 's049'; break;
    case 1: acc += 27; break;
    case 2: buf += 's2'; acc -= 18; break;
  ...
  m01.set('k50', acc % 997);
  try { if (acc % 29 === 19) { throw new Error('synthetic-51'); } acc += 47; } catch (e) { acc = (acc + 17) % 65521; }
  return buf + '|' + acc.toString(16) + '|' + u.name(tags.length.toString());
}

export function biz_0038_16(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4994) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const rc11: Rec38 = { id: acc % 1000, tag: 't11', score: acc % 100 };
  acc = (acc + rc11.score) % 65521;
  buf += rc11.tag;
  for (let i12 = 0; i12 < 3; i12++) {
    acc = (acc + i12 * 13 + 632) % 100003;
  }
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x13');
  const ix14: number = buf.indexOf('p38');
  if (ix14 > 12) { buf = buf.substring(0, 32); } else if (ix14 >= 0) { buf += 'i'; }
  const rc15: Rec38 = { id: acc % 1000, tag: 't15', score: acc % 100 };
  ...
  const cf39: Array<(x: number) => number> = [];
  cf39.push((x: number): number => (x * 3 + acc) % 65521);
  cf39.push((x: number): number => (x + 15) % 10007);
  acc = cf39[acc & 1](acc % 9973);
  const ix40: number = buf.indexOf('p38');
  ...
  try { if (acc % 29 === 18) { throw new Error('synthetic-45'); } acc += 12; } catch (e) { acc = (acc + 17) % 65521; }
  const t046: string = tags.length > 0 ? tags[0] : 'none';
  buf += t046;
...
export function biz_0038_17(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4995) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  for (let i8 = 0; i8 < 11; i8++) {
    acc = (acc + i8 * 13 + 657) % 100003;
  }
  try { if (acc % 29 === 13) { throw new Error('synthetic-9'); } acc += 29; } catch (e) { acc = (acc + 17) % 65521; }
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x10');
  const rc11: Rec38 = { id: acc % 1000, tag: 't11', score: acc % 100 };
  acc = (acc + rc11.score) % 65521;
  ...
  acc += w19;
  try { if (acc % 29 === 5) { throw new Error('synthetic-20'); } acc += 9; } catch (e) { acc = (acc + 17) % 65521; }
  const ix21: number = buf.indexOf('p38');
  if (ix21 > 12) { buf = buf.substring(0, 32); } else if (ix21 >= 0) { buf += 'i'; }
  try { if (acc % 29 === 9) { throw new Error('synthetic-22'); } acc += 48; } catch (e) { acc = (acc + 17) % 65521; }
  arr.push(acc % 1000);
  switch (acc & 3) {
  ...
  const rc32: Rec38 = { id: acc % 1000, tag: 't32', score: acc % 100 };
  ...
  acc = cf34[acc & 1](acc % 9973);
  const rc35: Rec38 = { id: acc % 1000, tag: 't35', score: acc % 100 };
  ...
  while (w42 > 4) { w42 = Math.floor(w42 / 2); }
  acc += w42;
  const rc43: Rec38 = { id: acc % 1000, tag: 't43', score: acc % 100 };
  acc = (acc + rc43.score) % 65521;
  buf += rc43.tag;
  m01.set('k44', acc % 997);
  for (let i45 = 0; i45 < 5; i45++) {
    acc = (acc + i45 * 13 + 351) % 100003;
  }
  arr.push(acc % 1000);
  buf += `q47:${acc % 97}`;
  const ix48: number = buf.indexOf('p38');
...
export function biz_0038_18(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4996) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  acc += w6;
  try { if (acc % 29 === 6) { throw new Error('synthetic-7'); } acc += 48; } catch (e) { acc = (acc + 17) % 65521; }
  buf += `q8:${acc % 97}`;
  ...
  try { if (acc % 29 === 15) { throw new Error('synthetic-16'); } acc += 60; } catch (e) { acc = (acc + 17) % 65521; }
  const cf17: Array<(x: number) => number> = [];
  cf17.push((x: number): number => (x * 3 + acc) % 65521);
  cf17.push((x: number): number => (x + 63) % 10007);
  acc = cf17[acc & 1](acc % 9973);
  ...
  const ix25: number = buf.indexOf('p38');
  ...
  const ix38: number = buf.indexOf('p38');
  if (ix38 > 12) { buf = buf.substring(0, 32); } else if (ix38 >= 0) { buf += 'i'; }
  try { if (acc % 29 === 4) { throw new Error('synthetic-39'); } acc += 39; } catch (e) { acc = (acc + 17) % 65521; }
  let w40: number = acc % 23;
  while (w40 > 4) { w40 = Math.floor(w40 / 2); }
  acc += w40;
  acc = (acc * 31 + 9663) % 65521;
  const rc42: Rec38 = { id: acc % 1000, tag: 't42', score: acc % 100 };
  acc = (acc + rc42.score) % 65521;
  buf += rc42.tag;
  ...
  for (let i47 = 0; i47 < 6; i47++) {
    acc = (acc + i47 * 13 + 840) % 100003;
  }
  try { if (acc % 29 === 10) { throw new Error('synthetic-48'); } acc += 39; } catch (e) { acc = (acc + 17) % 65521; }
  switch (acc & 3) {
    case 0: buf += 's049'; break;
    case 1: acc += 10; break;
    case 2: buf += 's2'; acc -= 15; break;
  ...
  m01.set('k50', acc % 997);
  acc = (acc * 31 + 8359) % 65521;
  return buf + '|' + acc.toString(16) + '|' + u.name(tags.length.toString());
}

export function biz_0038_19(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4997) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  cf3.push((x: number): number => (x + 53) % 10007);
  acc = cf3[acc & 1](acc % 9973);
  arr.push(acc % 1000);
  acc = (acc * 31 + 6152) % 65521;
  if (m01.has('k6')) {
    const gv6: number = m01.get('k6') as number;
    acc = (acc + gv6) % 10007;
  }
...
export async function biz_0038_19a(seed: number, raw: string): Promise<string> {
  const head: string = biz_0038_19(seed + 1, raw);
  const tick: number = await Promise.resolve(seed % 17);
  return head + '@' + tick.toString();
}

export function biz_0038_20(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4998) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  buf += `q5:${acc % 97}`;
  try { if (acc % 29 === 20) { throw new Error('synthetic-6'); } acc += 51; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  acc = cf12[acc & 1](acc % 9973);
  try { if (acc % 29 === 18) { throw new Error('synthetic-13'); } acc += 28; } catch (e) { acc = (acc + 17) % 65521; }
  m01.set('k14', acc % 997);
  ...
  for (let i20 = 0; i20 < 5; i20++) {
    acc = (acc + i20 * 13 + 656) % 100003;
  }
  if (acc % 29 === 0) { buf += 'even21'; } else { buf += 'odd'; }
  const ix22: number = buf.indexOf('p38');
  ...
  cf36.push((x: number): number => (x + 113) % 10007);
  acc = cf36[acc & 1](acc % 9973);
  for (let i37 = 0; i37 < 10; i37++) {
    acc = (acc + i37 * 13 + 426) % 100003;
  }
  const cf38: Array<(x: number) => number> = [];
  cf38.push((x: number): number => (x * 3 + acc) % 65521);
  cf38.push((x: number): number => (x + 196) % 10007);
  acc = cf38[acc & 1](acc % 9973);
  acc = (acc * 31 + 4770) % 65521;
  arr.push(acc % 1000);
  const ix41: number = buf.indexOf('p38');
  if (ix41 > 12) { buf = buf.substring(0, 32); } else if (ix41 >= 0) { buf += 'i'; }
  m01.set('k42', acc % 997);
  ...
  const db44: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db44.length) % 65521;
  const ix45: number = buf.indexOf('p38');
...
export function biz_0038_21(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 4999) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  buf += t07;
  try { if (acc % 29 === 21) { throw new Error('synthetic-8'); } acc += 45; } catch (e) { acc = (acc + 17) % 65521; }
  buf += `q9:${acc % 97}`;
  arr.push(acc % 1000);
  acc = (acc * 31 + 5477) % 65521;
  const cf12: Array<(x: number) => number> = [];
  cf12.push((x: number): number => (x * 3 + acc) % 65521);
  cf12.push((x: number): number => (x + 100) % 10007);
  acc = cf12[acc & 1](acc % 9973);
  ...
  try { if (acc % 29 === 9) { throw new Error('synthetic-20'); } acc += 31; } catch (e) { acc = (acc + 17) % 65521; }
  const rc21: Rec38 = { id: acc % 1000, tag: 't21', score: acc % 100 };
  acc = (acc + rc21.score) % 65521;
  buf += rc21.tag;
  const db22: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db22.length) % 65521;
  try { if (acc % 29 === 14) { throw new Error('synthetic-23'); } acc += 15; } catch (e) { acc = (acc + 17) % 65521; }
  acc = (acc * 31 + 4946) % 65521;
  const rc25: Rec38 = { id: acc % 1000, tag: 't25', score: acc % 100 };
  acc = (acc + rc25.score) % 65521;
  buf += rc25.tag;
  for (let i26 = 0; i26 < 12; i26++) {
    acc = (acc + i26 * 13 + 722) % 100003;
  }
  ...
  while (w29 > 4) { w29 = Math.floor(w29 / 2); }
  acc += w29;
  try { if (acc % 29 === 12) { throw new Error('synthetic-30'); } acc += 25; } catch (e) { acc = (acc + 17) % 65521; }
  const cf31: Array<(x: number) => number> = [];
  cf31.push((x: number): number => (x * 3 + acc) % 65521);
  cf31.push((x: number): number => (x + 72) % 10007);
  ...
  m01.set('k38', acc % 997);
  arr.push(acc % 1000);
  try { if (acc % 29 === 5) { throw new Error('synthetic-40'); } acc += 13; } catch (e) { acc = (acc + 17) % 65521; }
  switch (acc & 3) {
  ...
  acc = (acc + rc43.score) % 65521;
  buf += rc43.tag;
  try { if (acc % 29 === 21) { throw new Error('synthetic-44'); } acc += 40; } catch (e) { acc = (acc + 17) % 65521; }
  let w45: number = acc % 23;
  while (w45 > 4) { w45 = Math.floor(w45 / 2); }
  acc += w45;
  let w46: number = acc % 23;
  ...
  acc += w46;
  arr.push(acc % 1000);
  const rc48: Rec38 = { id: acc % 1000, tag: 't48', score: acc % 100 };
...
export function biz_0038_22(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5000) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  for (let i0 = 0; i0 < 3; i0++) {
    acc = (acc + i0 * 13 + 234) % 100003;
  }
  const cf1: Array<(x: number) => number> = [];
  cf1.push((x: number): number => (x * 3 + acc) % 65521);
  cf1.push((x: number): number => (x + 80) % 10007);
  ...
  for (let i19 = 0; i19 < 12; i19++) {
    acc = (acc + i19 * 13 + 91) % 100003;
  }
  const ix20: number = buf.indexOf('p38');
  ...
  const cf35: Array<(x: number) => number> = [];
  cf35.push((x: number): number => (x * 3 + acc) % 65521);
  cf35.push((x: number): number => (x + 35) % 10007);
  acc = cf35[acc & 1](acc % 9973);
  const db36: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db36.length) % 65521;
  ...
  const rc51: Rec38 = { id: acc % 1000, tag: 't51', score: acc % 100 };
  acc = (acc + rc51.score) % 65521;
  buf += rc51.tag;
  return buf + '|' + acc.toString(16) + '|' + u.name(tags.length.toString());
}

export function biz_0038_23(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5001) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const ix13: number = buf.indexOf('p38');
  ...
  buf += `q19:${acc % 97}`;
  acc = (acc * 31 + 5375) % 65521;
  arr.push(acc % 1000);
  acc = acc + 740 - (acc % 11);
  arr.push(acc % 1000);
  const cf24: Array<(x: number) => number> = [];
  cf24.push((x: number): number => (x * 3 + acc) % 65521);
  cf24.push((x: number): number => (x + 177) % 10007);
  acc = cf24[acc & 1](acc % 9973);
  buf += (acc > 500 ? 'hi25' : 'lo') + acc.toString(16);
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x26');
  ...
  buf += rc30.tag;
  buf += (acc > 500 ? 'hi31' : 'lo') + acc.toString(16);
  try { if (acc % 29 === 20) { throw new Error('synthetic-32'); } acc += 23; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  const ix36: number = buf.indexOf('p38');
  ...
  cf40.push((x: number): number => (x + 167) % 10007);
...
export function biz_0038_24(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5002) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  buf += t06;
  try { if (acc % 29 === 3) { throw new Error('synthetic-7'); } acc += 54; } catch (e) { acc = (acc + 17) % 65521; }
  if (acc % 17 === 0) { buf += 'even8'; } else { buf += 'odd'; }
  acc = (acc * 31 + 4250) % 65521;
  const cf10: Array<(x: number) => number> = [];
  cf10.push((x: number): number => (x * 3 + acc) % 65521);
  cf10.push((x: number): number => (x + 61) % 10007);
  acc = cf10[acc & 1](acc % 9973);
  for (let i11 = 0; i11 < 3; i11++) {
    acc = (acc + i11 * 13 + 789) % 100003;
  }
  m01.set('k12', acc % 997);
  ...
  try { if (acc % 29 === 9) { throw new Error('synthetic-51'); } acc += 23; } catch (e) { acc = (acc + 17) % 65521; }
  return buf + '|' + acc.toString(16) + '|' + u.name(tags.length.toString());
}

export function biz_0038_25(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5003) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const rc50: Rec38 = { id: acc % 1000, tag: 't50', score: acc % 100 };
...
export function biz_0038_26(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5004) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const rc1: Rec38 = { id: acc % 1000, tag: 't1', score: acc % 100 };
  acc = (acc + rc1.score) % 65521;
  buf += rc1.tag;
  for (let i2 = 0; i2 < 7; i2++) {
    acc = (acc + i2 * 13 + 793) % 100003;
  }
  arr.push(acc % 1000);
  buf += `q4:${acc % 97}`;
  acc = u.step(acc % 613) % 65521;
  ...
  acc = cf6[acc & 1](acc % 9973);
  try { if (acc % 29 === 9) { throw new Error('synthetic-7'); } acc += 46; } catch (e) { acc = (acc + 17) % 65521; }
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x8');
  const t09: string = tags.length > 0 ? tags[0] : 'none';
  buf += t09;
  ...
  const ix11: number = buf.indexOf('p38');
  ...
  const ix23: number = buf.indexOf('p38');
  if (ix23 > 12) { buf = buf.substring(0, 32); } else if (ix23 >= 0) { buf += 'i'; }
  m01.set('k24', acc % 997);
  for (let i25 = 0; i25 < 6; i25++) {
    acc = (acc + i25 * 13 + 382) % 100003;
  }
  switch (acc & 3) {
  ...
  const cf28: Array<(x: number) => number> = [];
  cf28.push((x: number): number => (x * 3 + acc) % 65521);
  cf28.push((x: number): number => (x + 118) % 10007);
  acc = cf28[acc & 1](acc % 9973);
  const ix29: number = buf.indexOf('p38');
  if (ix29 > 12) { buf = buf.substring(0, 32); } else if (ix29 >= 0) { buf += 'i'; }
  arr.push(acc % 1000);
...
export function biz_0038_27(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5005) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  const u: Unit38 = new Unit38(acc);
  try { if (acc % 29 === 17) { throw new Error('synthetic-0'); } acc += 32; } catch (e) { acc = (acc + 17) % 65521; }
  m01.set('k1', acc % 997);
  m01.set('k2', acc % 997);
  const rc3: Rec38 = { id: acc % 1000, tag: 't3', score: acc % 100 };
  acc = (acc + rc3.score) % 65521;
  ...
  const cf4: Array<(x: number) => number> = [];
  cf4.push((x: number): number => (x * 3 + acc) % 65521);
  cf4.push((x: number): number => (x + 120) % 10007);
  acc = cf4[acc & 1](acc % 9973);
  const ix5: number = buf.indexOf('p38');
  if (ix5 > 12) { buf = buf.substring(0, 32); } else if (ix5 >= 0) { buf += 'i'; }
  const ix6: number = buf.indexOf('p38');
  ...
  acc = acc + 382 - (acc % 8);
  try { if (acc % 29 === 4) { throw new Error('synthetic-22'); } acc += 49; } catch (e) { acc = (acc + 17) % 65521; }
  buf += (acc > 500 ? 'hi23' : 'lo') + acc.toString(16);
  const rc24: Rec38 = { id: acc % 1000, tag: 't24', score: acc % 100 };
  ...
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x27');
  const ix28: number = buf.indexOf('p38');
  ...
  acc = cf34[acc & 1](acc % 9973);
  try { if (acc % 29 === 16) { throw new Error('synthetic-35'); } acc += 26; } catch (e) { acc = (acc + 17) % 65521; }
  switch (acc & 3) {
    case 0: buf += 's036'; break;
    case 1: acc += 17; break;
    case 2: buf += 's2'; acc -= 5; break;
  ...
  m01.set('k44', acc % 997);
  buf += `q45:${acc % 97}`;
  try { if (acc % 29 === 18) { throw new Error('synthetic-46'); } acc += 20; } catch (e) { acc = (acc + 17) % 65521; }
...
export function biz_0038_28(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5006) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const cf25: Array<(x: number) => number> = [];
  cf25.push((x: number): number => (x * 3 + acc) % 65521);
  cf25.push((x: number): number => (x + 69) % 10007);
  acc = cf25[acc & 1](acc % 9973);
  buf += (acc > 500 ? 'hi26' : 'lo') + acc.toString(16);
  const db27: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db27.length) % 65521;
  ...
  try { if (acc % 29 === 22) { throw new Error('synthetic-29'); } acc += 8; } catch (e) { acc = (acc + 17) % 65521; }
  try { if (acc % 29 === 19) { throw new Error('synthetic-30'); } acc += 61; } catch (e) { acc = (acc + 17) % 65521; }
  const rc31: Rec38 = { id: acc % 1000, tag: 't31', score: acc % 100 };
  acc = (acc + rc31.score) % 65521;
  buf += rc31.tag;
  arr.push(acc % 1000);
...
export function biz_0038_29(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5007) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  try { if (acc % 29 === 16) { throw new Error('synthetic-14'); } acc += 53; } catch (e) { acc = (acc + 17) % 65521; }
  arr.push(acc % 1000);
  const t016: string = tags.length > 0 ? tags[0] : 'none';
  buf += t016;
  const cf17: Array<(x: number) => number> = [];
  ...
  acc = cf30[acc & 1](acc % 9973);
  try { if (acc % 29 === 7) { throw new Error('synthetic-31'); } acc += 42; } catch (e) { acc = (acc + 17) % 65521; }
  for (let i32 = 0; i32 < 7; i32++) {
    acc = (acc + i32 * 13 + 566) % 100003;
  }
  buf += (acc > 500 ? 'hi33' : 'lo') + acc.toString(16);
  const cf34: Array<(x: number) => number> = [];
  cf34.push((x: number): number => (x * 3 + acc) % 65521);
  ...
  arr.push(acc % 1000);
  buf += `q38:${acc % 97}`;
  try { if (acc % 29 === 3) { throw new Error('synthetic-39'); } acc += 42; } catch (e) { acc = (acc + 17) % 65521; }
...
export async function biz_0038_29a(seed: number, raw: string): Promise<string> {
  const head: string = biz_0038_29(seed + 1, raw);
  const tick: number = await Promise.resolve(seed % 17);
  return head + '@' + tick.toString();
}

export function biz_0038_30(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5008) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  while (w5 > 4) { w5 = Math.floor(w5 / 2); }
  acc += w5;
  const rc6: Rec38 = { id: acc % 1000, tag: 't6', score: acc % 100 };
  ...
  buf += (acc > 500 ? 'hi11' : 'lo') + acc.toString(16);
  try { if (acc % 29 === 12) { throw new Error('synthetic-12'); } acc += 7; } catch (e) { acc = (acc + 17) % 65521; }
  const rc13: Rec38 = { id: acc % 1000, tag: 't13', score: acc % 100 };
  ...
  acc = (acc + rc18.score) % 65521;
  buf += rc18.tag;
  const ix19: number = buf.indexOf('p38');
  if (ix19 > 12) { buf = buf.substring(0, 32); } else if (ix19 >= 0) { buf += 'i'; }
  try { if (acc % 29 === 4) { throw new Error('synthetic-20'); } acc += 41; } catch (e) { acc = (acc + 17) % 65521; }
  if (m01.has('k21')) {
    const gv21: number = m01.get('k21') as number;
    acc = (acc + gv21) % 10007;
  }
  ...
  const cf36: Array<(x: number) => number> = [];
  cf36.push((x: number): number => (x * 3 + acc) % 65521);
  cf36.push((x: number): number => (x + 179) % 10007);
  acc = cf36[acc & 1](acc % 9973);
  ...
  for (let i39 = 0; i39 < 11; i39++) {
    acc = (acc + i39 * 13 + 320) % 100003;
  }
  const ix40: number = buf.indexOf('p38');
  if (ix40 > 12) { buf = buf.substring(0, 32); } else if (ix40 >= 0) { buf += 'i'; }
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x41');
  try { if (acc % 29 === 10) { throw new Error('synthetic-42'); } acc += 26; } catch (e) { acc = (acc + 17) % 65521; }
  acc = (acc * 31 + 4358) % 65521;
  const rc44: Rec38 = { id: acc % 1000, tag: 't44', score: acc % 100 };
  acc = (acc + rc44.score) % 65521;
  buf += rc44.tag;
  if (acc % 15 === 0) { buf += 'even45'; } else { buf += 'odd'; }
  const rc46: Rec38 = { id: acc % 1000, tag: 't46', score: acc % 100 };
...
export function biz_0038_31(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5009) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const db12: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db12.length) % 65521;
  acc = (acc * 31 + 9877) % 65521;
  m01.set('k14', acc % 997);
  try { if (acc % 29 === 3) { throw new Error('synthetic-15'); } acc += 50; } catch (e) { acc = (acc + 17) % 65521; }
  acc = (acc * 31 + 9366) % 65521;
  const cf17: Array<(x: number) => number> = [];
  cf17.push((x: number): number => (x * 3 + acc) % 65521);
  ...
  for (let i23 = 0; i23 < 9; i23++) {
    acc = (acc + i23 * 13 + 902) % 100003;
  }
  if (acc % 25 === 0) { buf += 'even24'; } else { buf += 'odd'; }
  const cf25: Array<(x: number) => number> = [];
  cf25.push((x: number): number => (x * 3 + acc) % 65521);
  cf25.push((x: number): number => (x + 168) % 10007);
  acc = cf25[acc & 1](acc % 9973);
  try { if (acc % 29 === 18) { throw new Error('synthetic-26'); } acc += 27; } catch (e) { acc = (acc + 17) % 65521; }
  buf += (acc > 500 ? 'hi27' : 'lo') + acc.toString(16);
  buf += (acc > 500 ? 'hi28' : 'lo') + acc.toString(16);
  arr.push(acc % 1000);
  const ix30: number = buf.indexOf('p38');
  ...
  acc = cf34[acc & 1](acc % 9973);
  const ix35: number = buf.indexOf('p38');
  ...
  try { if (acc % 29 === 8) { throw new Error('synthetic-47'); } acc += 49; } catch (e) { acc = (acc + 17) % 65521; }
  acc = acc + 427 - (acc % 72);
  const rc49: Rec38 = { id: acc % 1000, tag: 't49', score: acc % 100 };
  acc = (acc + rc49.score) % 65521;
  buf += rc49.tag;
...
export function biz_0038_32(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5010) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  const u: Unit38 = new Unit38(acc);
  try { if (acc % 29 === 13) { throw new Error('synthetic-0'); } acc += 10; } catch (e) { acc = (acc + 17) % 65521; }
  const cf1: Array<(x: number) => number> = [];
  cf1.push((x: number): number => (x * 3 + acc) % 65521);
  cf1.push((x: number): number => (x + 48) % 10007);
  acc = cf1[acc & 1](acc % 9973);
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x2');
  let w3: number = acc % 23;
  ...
  const cf14: Array<(x: number) => number> = [];
  cf14.push((x: number): number => (x * 3 + acc) % 65521);
  cf14.push((x: number): number => (x + 169) % 10007);
  acc = cf14[acc & 1](acc % 9973);
  ...
  acc = acc + 427 - (acc % 19);
  try { if (acc % 29 === 3) { throw new Error('synthetic-27'); } acc += 30; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  const db32: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db32.length) % 65521;
  const rc33: Rec38 = { id: acc % 1000, tag: 't33', score: acc % 100 };
  ...
  for (let i38 = 0; i38 < 5; i38++) {
    acc = (acc + i38 * 13 + 503) % 100003;
  }
  arr.push(acc % 1000);
  acc = acc + 233 - (acc % 23);
  for (let i41 = 0; i41 < 8; i41++) {
    acc = (acc + i41 * 13 + 860) % 100003;
  }
  const db42: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db42.length) % 65521;
  acc = acc + 221 - (acc % 69);
...
export function biz_0038_33(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5011) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  const u: Unit38 = new Unit38(acc);
  const ix0: number = buf.indexOf('p38');
  if (ix0 > 12) { buf = buf.substring(0, 32); } else if (ix0 >= 0) { buf += 'i'; }
  for (let i1 = 0; i1 < 7; i1++) {
    acc = (acc + i1 * 13 + 858) % 100003;
  }
  arr.push(acc % 1000);
  if (m01.has('k3')) {
    const gv3: number = m01.get('k3') as number;
  ...
  try { if (acc % 29 === 12) { throw new Error('synthetic-16'); } acc += 53; } catch (e) { acc = (acc + 17) % 65521; }
  const cf17: Array<(x: number) => number> = [];
  cf17.push((x: number): number => (x * 3 + acc) % 65521);
  ...
  const cf41: Array<(x: number) => number> = [];
  cf41.push((x: number): number => (x * 3 + acc) % 65521);
  cf41.push((x: number): number => (x + 199) % 10007);
  acc = cf41[acc & 1](acc % 9973);
  if (m01.has('k42')) {
    const gv42: number = m01.get('k42') as number;
    acc = (acc + gv42) % 10007;
...
export function biz_0038_34(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5012) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  acc = (acc + db7.length) % 65521;
  acc = acc + 39 - (acc % 49);
  try { if (acc % 29 === 12) { throw new Error('synthetic-9'); } acc += 29; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  arr.push(acc % 1000);
  try { if (acc % 29 === 2) { throw new Error('synthetic-24'); } acc += 42; } catch (e) { acc = (acc + 17) % 65521; }
  acc = (acc * 31 + 5564) % 65521;
  for (let i26 = 0; i26 < 6; i26++) {
    acc = (acc + i26 * 13 + 318) % 100003;
  }
  if (acc % 19 === 0) { buf += 'even27'; } else { buf += 'odd'; }
  buf += (acc > 500 ? 'hi28' : 'lo') + acc.toString(16);
  const ix29: number = buf.indexOf('p38');
  ...
  const cf39: Array<(x: number) => number> = [];
  cf39.push((x: number): number => (x * 3 + acc) % 65521);
  cf39.push((x: number): number => (x + 93) % 10007);
  acc = cf39[acc & 1](acc % 9973);
  switch (acc & 3) {
    case 0: buf += 's040'; break;
    case 1: acc += 6; break;
  ...
  try { if (acc % 29 === 2) { throw new Error('synthetic-45'); } acc += 43; } catch (e) { acc = (acc + 17) % 65521; }
  for (let i46 = 0; i46 < 9; i46++) {
    acc = (acc + i46 * 13 + 510) % 100003;
  }
  let w47: number = acc % 23;
  while (w47 > 4) { w47 = Math.floor(w47 / 2); }
  acc += w47;
...
export function biz_0038_35(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5013) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  m01.set('k2', acc % 997);
  try { if (acc % 29 === 15) { throw new Error('synthetic-3'); } acc += 31; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  const cf28: Array<(x: number) => number> = [];
  cf28.push((x: number): number => (x * 3 + acc) % 65521);
  cf28.push((x: number): number => (x + 19) % 10007);
  acc = cf28[acc & 1](acc % 9973);
  try { if (acc % 29 === 19) { throw new Error('synthetic-29'); } acc += 22; } catch (e) { acc = (acc + 17) % 65521; }
  m01.set('k30', acc % 997);
  buf += (acc > 500 ? 'hi31' : 'lo') + acc.toString(16);
  buf += 'balance32-' + acc.toString();
  for (let i33 = 0; i33 < 9; i33++) {
    acc = (acc + i33 * 13 + 459) % 100003;
  }
  const cf34: Array<(x: number) => number> = [];
  cf34.push((x: number): number => (x * 3 + acc) % 65521);
  cf34.push((x: number): number => (x + 117) % 10007);
  acc = cf34[acc & 1](acc % 9973);
  try { if (acc % 29 === 22) { throw new Error('synthetic-35'); } acc += 35; } catch (e) { acc = (acc + 17) % 65521; }
  const rc36: Rec38 = { id: acc % 1000, tag: 't36', score: acc % 100 };
  acc = (acc + rc36.score) % 65521;
  buf += rc36.tag;
  const ix37: number = buf.indexOf('p38');
  ...
  const cf42: Array<(x: number) => number> = [];
  cf42.push((x: number): number => (x * 3 + acc) % 65521);
  cf42.push((x: number): number => (x + 80) % 10007);
  acc = cf42[acc & 1](acc % 9973);
  switch (acc & 3) {
    case 0: buf += 's043'; break;
    case 1: acc += 25; break;
...
export function biz_0038_36(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5014) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  acc = acc + 967 - (acc % 37);
  try { if (acc % 29 === 17) { throw new Error('synthetic-11'); } acc += 34; } catch (e) { acc = (acc + 17) % 65521; }
  arr.push(acc % 1000);
  try { if (acc % 29 === 8) { throw new Error('synthetic-13'); } acc += 6; } catch (e) { acc = (acc + 17) % 65521; }
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x14');
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x15');
  ...
  const cf19: Array<(x: number) => number> = [];
  cf19.push((x: number): number => (x * 3 + acc) % 65521);
  cf19.push((x: number): number => (x + 93) % 10007);
  acc = cf19[acc & 1](acc % 9973);
  if (acc % 17 === 0) { buf += 'even20'; } else { buf += 'odd'; }
  buf += 'bay21-' + acc.toString();
  try { if (acc % 29 === 11) { throw new Error('synthetic-22'); } acc += 22; } catch (e) { acc = (acc + 17) % 65521; }
  m01.set('k23', acc % 997);
...
export function biz_0038_37(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5015) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  try { if (acc % 29 === 22) { throw new Error('synthetic-19'); } acc += 42; } catch (e) { acc = (acc + 17) % 65521; }
  buf += `q20:${acc % 97}`;
  buf += `q21:${acc % 97}`;
  ...
  const db45: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db45.length) % 65521;
  try { if (acc % 29 === 17) { throw new Error('synthetic-46'); } acc += 17; } catch (e) { acc = (acc + 17) % 65521; }
  const t047: string = tags.length > 0 ? tags[0] : 'none';
  buf += t047;
  acc = acc + 757 - (acc % 56);
...
export function biz_0038_38(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5016) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  buf += (acc > 500 ? 'hi11' : 'lo') + acc.toString(16);
  const ix12: number = buf.indexOf('p38');
  ...
  const cf39: Array<(x: number) => number> = [];
  cf39.push((x: number): number => (x * 3 + acc) % 65521);
  cf39.push((x: number): number => (x + 124) % 10007);
  acc = cf39[acc & 1](acc % 9973);
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x40');
  const db41: number[] = arr.map((v: number): number => v + (acc % 13));
  ...
  buf += 'balance44-' + acc.toString();
  arr.push(acc % 1000);
  const ix46: number = buf.indexOf('p38');
  if (ix46 > 12) { buf = buf.substring(0, 32); } else if (ix46 >= 0) { buf += 'i'; }
  for (let i47 = 0; i47 < 10; i47++) {
    acc = (acc + i47 * 13 + 808) % 100003;
  }
  const t048: string = tags.length > 0 ? tags[0] : 'none';
  buf += t048;
  acc = acc + 622 - (acc % 94);
  for (let i50 = 0; i50 < 9; i50++) {
    acc = (acc + i50 * 13 + 300) % 100003;
  }
  const cf51: Array<(x: number) => number> = [];
  cf51.push((x: number): number => (x * 3 + acc) % 65521);
...
export function biz_0038_39(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5017) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const cf4: Array<(x: number) => number> = [];
  cf4.push((x: number): number => (x * 3 + acc) % 65521);
  cf4.push((x: number): number => (x + 131) % 10007);
  acc = cf4[acc & 1](acc % 9973);
  const db5: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db5.length) % 65521;
  buf += `q6:${acc % 97}`;
  ...
  const cf16: Array<(x: number) => number> = [];
  cf16.push((x: number): number => (x * 3 + acc) % 65521);
  cf16.push((x: number): number => (x + 114) % 10007);
  acc = cf16[acc & 1](acc % 9973);
  const cf17: Array<(x: number) => number> = [];
  cf17.push((x: number): number => (x * 3 + acc) % 65521);
  cf17.push((x: number): number => (x + 47) % 10007);
  ...
  for (let i26 = 0; i26 < 4; i26++) {
    acc = (acc + i26 * 13 + 919) % 100003;
  }
  const ix27: number = buf.indexOf('p38');
  ...
  try { if (acc % 29 === 4) { throw new Error('synthetic-32'); } acc += 55; } catch (e) { acc = (acc + 17) % 65521; }
  for (let i33 = 0; i33 < 12; i33++) {
    acc = (acc + i33 * 13 + 731) % 100003;
  }
  const cf34: Array<(x: number) => number> = [];
  cf34.push((x: number): number => (x * 3 + acc) % 65521);
  cf34.push((x: number): number => (x + 100) % 10007);
...
export async function biz_0038_39a(seed: number, raw: string): Promise<string> {
  const head: string = biz_0038_39(seed + 1, raw);
  const tick: number = await Promise.resolve(seed % 17);
  return head + '@' + tick.toString();
}

export function biz_0038_40(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5018) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const cf3: Array<(x: number) => number> = [];
  cf3.push((x: number): number => (x * 3 + acc) % 65521);
  cf3.push((x: number): number => (x + 85) % 10007);
  acc = cf3[acc & 1](acc % 9973);
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x4');
  m01.set('k5', acc % 997);
  ...
  for (let i18 = 0; i18 < 3; i18++) {
    acc = (acc + i18 * 13 + 37) % 100003;
  }
  arr.push(acc % 1000);
  for (let i20 = 0; i20 < 10; i20++) {
    acc = (acc + i20 * 13 + 223) % 100003;
  }
  const rc21: Rec38 = { id: acc % 1000, tag: 't21', score: acc % 100 };
  acc = (acc + rc21.score) % 65521;
  buf += rc21.tag;
  for (let i22 = 0; i22 < 5; i22++) {
    acc = (acc + i22 * 13 + 101) % 100003;
  }
  let w23: number = acc % 23;
  while (w23 > 4) { w23 = Math.floor(w23 / 2); }
  acc += w23;
  ...
  cf32.push((x: number): number => (x + 39) % 10007);
  ...
  const db36: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db36.length) % 65521;
  const rc37: Rec38 = { id: acc % 1000, tag: 't37', score: acc % 100 };
  acc = (acc + rc37.score) % 65521;
  buf += rc37.tag;
  acc = (acc * 31 + 5538) % 65521;
  buf += (acc > 500 ? 'hi39' : 'lo') + acc.toString(16);
  acc = (acc * 31 + 6130) % 65521;
  for (let i41 = 0; i41 < 6; i41++) {
    acc = (acc + i41 * 13 + 241) % 100003;
  }
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x42');
  if (m01.has('k43')) {
  ...
  acc = u.step(acc % 613) % 65521;
  buf += u.name('x50');
  try { if (acc % 29 === 16) { throw new Error('synthetic-51'); } acc += 55; } catch (e) { acc = (acc + 17) % 65521; }
  return buf + '|' + acc.toString(16) + '|' + u.name(tags.length.toString());
}

export function biz_0038_41(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5019) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  const db6: number[] = arr.map((v: number): number => v + (acc % 13));
  acc = (acc + db6.length) % 65521;
  try { if (acc % 29 === 8) { throw new Error('synthetic-7'); } acc += 40; } catch (e) { acc = (acc + 17) % 65521; }
  if (m01.has('k8')) {
    const gv8: number = m01.get('k8') as number;
    acc = (acc + gv8) % 10007;
  }
  for (let i9 = 0; i9 < 7; i9++) {
    acc = (acc + i9 * 13 + 183) % 100003;
  }
  acc = (acc * 31 + 2895) % 65521;
  for (let i11 = 0; i11 < 9; i11++) {
    acc = (acc + i11 * 13 + 165) % 100003;
  }
  ...
  acc = cf17[acc & 1](acc % 9973);
  try { if (acc % 29 === 16) { throw new Error('synthetic-18'); } acc += 11; } catch (e) { acc = (acc + 17) % 65521; }
  acc = acc + 489 - (acc % 67);
  buf += 'client20-' + acc.toString();
  try { if (acc % 29 === 6) { throw new Error('synthetic-21'); } acc += 15; } catch (e) { acc = (acc + 17) % 65521; }
  ...
  const cf30: Array<(x: number) => number> = [];
  cf30.push((x: number): number => (x * 3 + acc) % 65521);
  cf30.push((x: number): number => (x + 109) % 10007);
  acc = cf30[acc & 1](acc % 9973);
  const t031: string = tags.length > 0 ? tags[0] : 'none';
  buf += t031;
  for (let i32 = 0; i32 < 7; i32++) {
    acc = (acc + i32 * 13 + 399) % 100003;
  }
  const rc33: Rec38 = { id: acc % 1000, tag: 't33', score: acc % 100 };
  acc = (acc + rc33.score) % 65521;
  buf += rc33.tag;
  ...
  for (let i49 = 0; i49 < 6; i49++) {
    acc = (acc + i49 * 13 + 354) % 100003;
  }
  for (let i50 = 0; i50 < 8; i50++) {
    acc = (acc + i50 * 13 + 220) % 100003;
  }
  arr.push(acc % 1000);
  return buf + '|' + acc.toString(16) + '|' + u.name(tags.length.toString());
}

export function biz_0038_42(seed: number, raw: string): string {
  let acc: number = (seed * 31 + raw.length + 5020) % 100003;
  let buf: string = raw.length.toString(16) + ':';
  const tags: string[] = raw.split('-');
  const m01: Map<string, number> = new Map<string, number>();
  const arr: number[] = [];
  ...
  buf += (acc > 500 ? 'hi20' : 'lo') + acc.toString(16);
  m01.set('k21', acc % 997);
  try { if (acc % 29 === 23) { throw new Error('synthetic-22'); } acc += 42; } catch (e) { acc = (acc + 17) % 65521; }
  acc = acc + 274 - (acc % 49);
  let w24: number = acc % 23;
  while (w24 > 4) { w24 = Math.floor(w24 / 2); }
  acc += w24;
  ...
  const t042: string = tags.length > 0 ? tags[0] : 'none';
  buf += t042;
  const ix43: number = buf.indexOf('p38');
  ...
  buf += u.name('x48');
  m01.set('k49', acc % 997);
  acc = (acc * 31 + 4621) % 65521;
  acc = acc + 303 - (acc % 79);
  return buf + '|' + acc.toString(16) + '|' + u.name(tags.length.toString());
}

export function reg_0038(): BizFn[] {
  return [biz_0038_00, biz_0038_01, biz_0038_02, biz_0038_03, biz_0038_04, biz_0038_05, biz_0038_06, biz_0038_07, biz_0038_08, biz_0038_09, biz_0038_10, biz_0038_11, biz_0038_12, biz_0038_13, biz_0038_14, biz_0038_15, biz_0038_16, biz_0038_17, biz_0038_18, biz_0038_19, biz_0038_20, biz_0038_21, biz_0038_22, biz_0038_23, biz_0038_24, biz_0038_25, biz_0038_26, biz_0038_27, biz_0038_28, biz_0038_29, biz_0038_30, biz_0038_31, biz_0038_32, biz_0038_33, biz_0038_34, biz_0038_35, biz_0038_36, biz_0038_37, biz_0038_38, biz_0038_39, biz_0038_40, biz_0038_41, biz_0038_42];
}

export function rega_0038(): ABizFn[] {
  return [biz_0038_09a, biz_0038_19a, biz_0038_29a, biz_0038_39a];
}
