...
| CRYPTO | 8 | 弱算法/弱模式/短密钥/固定 IV·nonce | 327/328/329/321/326/1204/916 |
| NET | 6 | 明文传输/证书校验绕过（含存储凭据回传链） | 319/295 |
| WEB | 8 | WebView 调试/桥暴露/XSS/混合内容/文件访问/开放跳转/无来源校验桥 | 489/749/94/311/79/601 |
...
| TNT | 1 | 跨函数污点链（source/sink 分置，interproc 规则） | 200 |

共 34 族 97 条（另有同数安全孪生，manifest 总条目 194）。
<!-- VULNS-OVERVIEW:END -->
